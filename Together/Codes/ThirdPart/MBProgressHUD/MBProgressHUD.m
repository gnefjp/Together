...
- (void)dealloc {
    ...
    [labelText release]; labelText = nil;
    [detailsLabelText release]; detailsLabelText = nil;
	[graceTimer release]; graceTimer = nil;
	[minShowTimer release]; minShowTimer = nil;
	[showStarted release]; showStarted = nil;
