...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _viscous = 55.0f;
        _radius = 13.0f;
        _bodyColor = [UIColor colorWithRed:172.0/255.0 green:176.0/255.0 blue:174.0/255.0 alpha:1.0];
        _skinColor = [UIColor colorWithRed:172.0/255.0 green:176.0/255.0 blue:174.0/255.0 alpha:1.0];
        ...
        case SRSlimeStateNormal:
        {
            ...
            if (percent == 1) {
                ...
                if (percent <= 0) {
                    ...
                    if ([_delegate respondsToSelector:@selector(SRSlimeViewPullApart:)])
                    {
                        [_delegate SRSlimeViewPullApart:self];
                    }
