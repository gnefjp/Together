...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _slime.delegate = self;
    }
    return self;
}


#pragma mark- SRSlimeViewDelegate
- (void) SRSlimeViewPullApart:(SRSlimeView *)slimeView
{
    [self pullApart:self];
}
...
- (void)pullApart:(SRRefreshView*)refreshView
{
    ...
    [self performSelector:@selector(_startRefresh)
               withObject:nil
               afterDelay:0.01];
}
